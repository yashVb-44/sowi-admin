...
import { addVehicle, getAllVehicle } from "../../Lib/VehicleApi";
...
const CreateVehicle = ({ openVehicleCreate, handleCloseVehicleCreate }) => {
  ...
  const handleCompanies = async () => {
    ...
    console.log("Companies for service type:", response);
    ...
    try {
      ...
      if (response.type === "success") {
        ...
        setTimeout(() => {
          ...
          setCompany("");
          setFilePreview("");
          Alert("Success", "Vehicle Created successfully", "success");
        }, 100);
      } else {
        setLoader(false);
        handleModelClose();
        ...
        <Box className="CreateCommonModal">
          ...
          <Grid container spacing={6} sx={{ paddingRight: "30px" }}>
            ...
            <Grid item xs={12} md={6} lg={6} className="CreateCommonFields">
              ...
              >
                ...
                {company === "" && <MenuItem value="">Select Company</MenuItem>}
              </Select>
            </Grid>
          </Grid>
          ...
          >
            <Button
              ...
              disabled={loader}
            >
              {loader ? "Creating..." : "Create Vehicle"}
            </Button>
          </Box>
        </Box>
      </Modal>
